...
with st.sidebar:
    selected = option_menu("Menu", ["Home","Overview","Explore"], 
                           ...
                           default_index=0,
                           styles={"nav-link": {"font-size": "24px", "text-align": "left", "margin": "-2px", "--hover-color": "#517fc9"},
                                   "nav-link-selected": {"background-color": "#C0C0C0"}}
                          )
    


#reading the cleaned dataframe
df = pd.read_csv(r'C:\Users\hp\airbnb_data.csv')
#home page
if selected == "Home":
